      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            <span>&quot;Site&quot;</span>). Our goal is to ensure a seamless and
            transparent shipping process for your convenience and satisfaction.
            Below are the details of our shipping process.
          </p>
        </div>
        <div>
