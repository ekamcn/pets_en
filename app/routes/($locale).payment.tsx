      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            When you place an order on our website, your card is charged
            immediately and not at the time of shipment. Your billing statement
            will appear as: {import.meta.env.VITE_COMPANY_NAME}
          </p>
        </div>
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            We accept payments by credit card (Visa, MasterCard, American
            Express). For credit card payments, your credit card information
            will be processed securely by our payment service provider.
          </p>
        </div>
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            Once your order is placed, a detailed invoice will be sent to you by
            email. Please verify the billing and shipping information to ensure
            proper receipt of your order.
          </p>
        </div>
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            and shipping information. If these details change, you must inform
            us as soon as possible to avoid any delay or delivery issues.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            In case of complaints or disputes regarding a transaction, please
            contact us at the email address mentioned above. We will strive to
            resolve any complaint as quickly as possible.
          </p>
        </div>
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            We reserve the right to modify these payment terms at any time. Any
            modification will be published on this page and you will be informed
            by email. By continuing to use our site after the publication of
            modifications, you accept them.
          </p>
        </div>
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">
