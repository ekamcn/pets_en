    ...
    return (
        <div className="bg-white min-h-screen py-8 sm:py-12 px-4 sm:px-5 [&_ul]:-indent-[1.3em]">
            <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
                ...
                <div>
                    <p className='leading-6 sm:leading-7 !text-sm sm:!text-base !pb-4'>Last Updated: {import.meta.env.VITE_PP_LAST_UPDATED_DATE}</p>
                ...
                <div>
                    ...
                    <p className='leading-6 sm:leading-7 !text-sm sm:!text-base !pb-4'>Refund Approval: Once we receive and inspect your returned item, we will notify you regarding the approval status within {import.meta.env.VITE_REFUND_PROCESSING_TIME} business days.</p>
                    <ul className="!list-disc !list-inside text-gray-700 space-y-2 !text-sm sm:!text-base !pl-6 lg:!pl-8">
                        <li>Processing Time: Approved refunds will be processed to your original payment method within {import.meta.env.VITE_REFUND_PROCESSING_TIME} business days. Your bank or credit card provider may require additional time to post the refund.</li>
                ...
                <div>
                    ...
                    <ul className="!list-disc !list-inside text-gray-700 space-y-2 !text-sm sm:!text-base !pl-6 lg:!pl-8">
                        ...
                        <li>Inspection Period: Once received, returns are inspected within {import.meta.env.VITE_REFUND_PROCESSING_TIME} business days.</li>
                        <li>Refund Issuance: Refunds are processed to the original payment method within {import.meta.env.VITE_REFUND_PROCESSING_TIME} business days after inspection.</li>
                    </ul>
                </div>
                <div>
