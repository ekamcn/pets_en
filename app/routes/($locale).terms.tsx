      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            <span>&quot;Site&quot;</span>). We are dedicated to providing
            high-quality e-commerce products and services. This document
            outlines the terms and conditions governing your use of our Site.
          </p>
        </div>
        <div>
        ...
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">Definitions</h2>
          ...
          <ul className="!list-disc !list-inside text-gray-700 space-y-2 !text-sm sm:!text-base !pl-6 lg:!pl-8">
            ...
            <li>
              ...
              &quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or
              &quot;our,&quot; it refers to {import.meta.env.VITE_COMPANY_NAME},{' '}
              {import.meta.env.VITE_COMPANY_ADDRESS}, which is responsible for
              your information under these General Terms and Conditions.
            </li>
            <li>
              <strong>Country:</strong> The location where{' '}
              {import.meta.env.VITE_COMPANY_NAME} or the owners/founders of{' '}
              {import.meta.env.VITE_COMPANY_NAME} are based.
            </li>
            <li>
              ...
              visit {import.meta.env.VITE_COMPANY_NAME} and use the services.
            </li>
            <li>
              <strong>Service:</strong> Refers to the services provided by{' '}
              {import.meta.env.VITE_COMPANY_NAME} as described in the relevant
            ...
            <li>
              Website: {import.meta.env.VITE_COMPANY_NAME}&apos;s site, which
              can be accessed via this URL: {import.meta.env.VITE_DOMAIN_NAME}.
            </li>
            <li>
              You: A person or entity that is registered with{' '}
              {import.meta.env.VITE_COMPANY_NAME} to use the Services.
            </li>
          </ul>
        </div>
        ...
        <div>
          <h2 className="!text-xl sm:!text-2xl font-semibold">Restrictions</h2>
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base !pb-4">
          ...
          <ul className="!list-disc !list-inside text-gray-700 space-y-2 !text-sm sm:!text-base !pl-6 lg:!pl-8">
            ...
            <li>
              ...
              {import.meta.env.VITE_COMPANY_NAME} or its affiliates, partners,
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            Under no circumstances shall {import.meta.env.VITE_COMPANY_NAME} be
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            {import.meta.env.VITE_COMPANY_NAME}, its affiliates, and employees
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
              ...
              {import.meta.env.VITE_COMPANY_NAME} regarding the website shall
              remain the sole and exclusive property of{' '}
              {import.meta.env.VITE_COMPANY_NAME}.
            </p>
            <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
              {import.meta.env.VITE_COMPANY_NAME} shall be free to use, copy,
              modify, publish, or redistribute the Suggestions for any purpose
              and in any way without any credit or compensation to you.
            </p>
          </div>
        </div>
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            We&apos;ve updated our General Terms and Conditions to provide you
            with complete transparency regarding what is set when you visit our
            site and how it&apos;s being used. By using our website, registering
            an account, or making a purchase, you hereby consent to our General
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            controlled by {import.meta.env.VITE_COMPANY_NAME}. We are not
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            a small piece of data stored on your computer or mobile device by
            ...
            However, without these cookies, certain functionalities like videos
