      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10 tracking-wider">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base">
            ...
            <span>&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;</span>)
            operates the website {import.meta.env.VITE_DOMAIN_NAME} (the
            &quot;Site&quot;). We are a company that provides various services
            and products. This Privacy Policy describes how we collect, use,
        ...
        <div>
          ...
          <h3 className="!text-base sm:!text-xl font-semibold !pb-3">
            Personal Identification Information
          </h3>
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base lg:!text-base !pb-4">
        ...
        <div>
          <h3 className="!text-lg sm:!text-xl font-semibold !pb-3">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base lg:!text-base">
            Our Site may use &quot;cookies&quot; to improve User experience.
            Cookies are small files stored on your device by your web browser to
            help remember settings and preferences, and track site usage. Users
            can configure their browser settings to refuse cookies or alert them
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base !pb-4 lg:!text-base">
        ...
        <div>
          ...
          <p className="leading-6 sm:leading-7 !text-sm sm:!text-base lg:!text-base">
            ...
            recognized transfer mechanisms, such as the European
            Commission&apos;s Standard Contractual Clauses, or equivalent
            agreements from the relevant competent authority in the UK (if
            applicable) unless the data transfer is to a country deemed to
